...
export const dishes: Dish[] = [
  ...
  },
  {
    ...
    description: "Tandoor-charred cottage cheese in a rich, spiced tomato gravy",
    price: 495,
    category: "Mains",
    rating: "4.8",
    time: "20 min",
    image: "/dishes/paneer_tikka_masala.jpg",
    tag: "Classic",
    veg: true,
  },
  {
    id: "garlic-naan",
    name: "Burnt Garlic Naan",
    description: "Leavened flatbread brushed with ghee, minced garlic, and cilantro",
    price: 125,
    category: "Breads",
    rating: "4.9",
    time: "8 min",
